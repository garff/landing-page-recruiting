            ...
            <div className="flex justify-center mb-8">
              <TabsList>
                <TabsTrigger value="monthly">
                  {t.business.pricing.monthlyBilling}
                </TabsTrigger>
                <TabsTrigger value="annual">
                  {t.business.pricing.annualBilling}
                </TabsTrigger>
              </TabsList>
            </div>
                    ...
                    <CardContent className="flex-grow">
                      <ul className="space-y-3">
                        ...
                        {plan.limitations.map((limitation, i) => (
                          ...
                          >
                            <X
                              className="h-5 w-5 text-muted-foreground mr-2 flex-shrink-0 mt-0.5"
                              aria-hidden="true"
                            />
              ...
              <thead>
                <tr className="border-b">
                  <th className="py-4 px-6 text-left font-medium">
                    {t.business.pricing.feature}
                  </th>
                  <th className="py-4 px-6 text-center font-medium">
                    {t.business.pricing.plans.starter.name}
                  </th>
                  <th className="py-4 px-6 text-center font-medium">
                    {t.business.pricing.plans.professional.name}
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b">
                  <td className="py-4 px-6 text-sm">
                    {
                      t.business.pricing.plans.starter.features[0].split(
                        'Up to '
                      )[1]
                    }
                  </td>
                ...
                <tr className="border-b">
                  <td className="py-4 px-6 text-sm">
                    {t.business.pricing.plans.professional.features[6]}
                  </td>
                  <td className="py-4 px-6 text-center text-sm">
                    <X
                      className="h-5 w-5 text-muted-foreground mx-auto"
          ...
          <div className="space-y-6">
            <div className="bg-card rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-medium mb-2">
                {t.business.pricing.faq.question1}
              </h3>
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-medium mb-2">
                {t.business.pricing.faq.question2}
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-medium mb-2">
                {t.business.pricing.faq.question3}
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-medium mb-2">
                {t.business.pricing.faq.question4}
              </h3>
              <p className="text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <Button size="lg" className="w-full text-sm sm:text-base">
                {t.business.pricing.startFreeTrial}{' '}

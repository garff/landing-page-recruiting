          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-2 border-border hover:border-primary/50 transition-colors w-2/3 mx-auto sm:w-2/3 sm:mx-auto md:w-full md:mx-0">
              <CardHeader className="space-y-1 text-center sm:text-center md:text-left">
                <div
                  className="bg-primary/10 w-12 h-12 rounded-full flex items-center justify-center mb-2 mx-auto sm:mx-auto md:mx-0"
                  aria-hidden="true"
                >
                  <FileText className="h-6 w-6 text-primary" />
                </div>
                <CardTitle className="text-lg sm:text-xl">
                  {t.home.features.resumeBuilder.title}
                </CardTitle>
            ...
            <Card className="border-2 border-primary shadow-lg relative w-2/3 mx-auto sm:w-2/3 sm:mx-auto md:w-full md:mx-0">
              <div className="absolute -top-3 -right-3">
                <Badge className="bg-primary text-white text-xs">
                  {t.home.features.applicationAssistant.badge}
                </Badge>
              </div>
              <CardHeader className="space-y-1 text-center sm:text-center md:text-left">
                <div
                ...
                <CardTitle className="text-lg sm:text-xl">
                  {t.home.features.applicationAssistant.title}
                </CardTitle>
                <CardDescription className="text-sm">
            ...
            <Card className="border-2 border-border hover:border-primary/50 transition-colors w-2/3 mx-auto sm:w-2/3 sm:mx-auto md:w-full md:mx-0">
              <CardHeader className="space-y-1 text-center sm:text-center md:text-left">
                ...
                <CardTitle className="text-lg sm:text-xl">
                  {t.home.features.talentMatching.title}
                </CardTitle>
                <CardDescription className="text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="w-2/3 mx-auto sm:w-2/3 sm:mx-auto md:w-full md:mx-0">
              ...
              <CardFooter className="flex items-center gap-4 pt-0 justify-center">
                <div
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-primary/20 flex items-center justify-center"
                  aria-hidden="true"
                >
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="hidden md:block flex-1 order-1 relative">
              <div className="relative">
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6 border border-border z-10 relative">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <div
                        className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary/20"
                        aria-hidden="true"
                      ></div>
                      <div className="space-y-2">
                        <div
                          className="h-3 sm:h-4 bg-muted rounded-md w-32"
                          aria-hidden="true"
                        ></div>
                        <div
                          className="h-2 sm:h-3 bg-muted rounded-md w-24"
                          aria-hidden="true"
                        ></div>
                      </div>
                      <div className="ml-auto">
                        <div
                          className="h-6 sm:h-8 w-16 sm:w-20 bg-primary/20 rounded-md"
                          aria-hidden="true"
                        ></div>
                      </div>
                    </div>
                ...
                <div
                  className="absolute -bottom-6 -right-6 z-0 bg-secondary rounded-lg shadow-lg p-6 border border-border w-5/6 h-full"
                  aria-hidden="true"
                ></div>
              </div>
            </div>
            <div className="flex-1 space-y-6 order-1 md:order-2">
              ...
              <h2
                ...
                className="text-2xl sm:text-3xl font-bold text-center sm:text-center md:text-left"
              >
              ...
              <div className="pt-4 flex justify-center sm:justify-center md:justify-start">
                <Link
                  href="/business"
                  className="w-2/3 md:w-2/3 mx-auto sm:mx-auto md:mx-0"
                >
                  <Button size="lg" className="w-full text-sm sm:text-base">

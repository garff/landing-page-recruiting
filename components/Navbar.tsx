      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2" aria-label="JobPortalen Home">
              <Image 
                src="/logo.png" 
              ...
              />
              <span className="font-bold text-xl">Jo<span className="text-primary">b</span>Portalen</span>
            </Link>
          </div>
